/**
 * rules.js — Lógica de negocio de la Ficha de Rol (secciones 3 y 4 del brief).
 *
 * ESTO ES CÓDIGO, NO CONFIGURACIÓN.
 * No hay pantalla de "ajustes" para editar nada de este archivo. Si una regla
 * cambia, cambia acá, se commitea y queda versionada. La app aplica esto
 * siempre, aunque el usuario no configure absolutamente nada.
 *
 ...
 * ────────────────────────────────────────────────────────────────────────── */
export const DECISIONES_PROPIAS = [
...
export const CATEGORIAS = [
  { id: 'estudio', n: 1, nombre: 'Estudio', color: '#7aa2f7',
  ...
  { id: 'estrategia', n: 2, nombre: 'Estrategia y planificación', color: '#9ece6a',
  ...
  { id: 'reuniones', n: 3, nombre: 'Reuniones internas', color: '#bb9af7',
  ...
  { id: 'equipo', n: 4, nombre: 'Gestión equipo / consultas', color: '#e0af68',
  ...
  { id: 'ventas', n: 5, nombre: 'Venta y clientes', color: '#7dcfff',
  ...
  { id: 'marketing', n: 6, nombre: 'Marketing', color: '#f7768e',
  ...
  { id: 'operativa', n: 7, nombre: 'Ejecución operativa', color: '#ff9e64', operativa: true,
  ...
  { id: 'personal', n: 8, nombre: 'Personal/admin', color: '#565f89',
...
export const UMBRALES = [
  ...
  },
  {
    ...
    evaluar(t) {
      ...
      if (h >= 2) return { estado: 'rojo', valor: h, texto: `${fmtH(h)} en un día: eso es media jornada haciendo lo que tiene otro dueño.` };
